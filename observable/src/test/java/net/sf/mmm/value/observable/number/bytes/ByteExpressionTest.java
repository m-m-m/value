...
import net.sf.mmm.value.observable.number.bytes.ByteBinding;
...
public class ByteExpressionTest extends NumberExpressionTest<Byte> {
  ...
  public void testDivideCustom() {
    ...
    value.setValue(Byte.valueOf((byte) 32));
    ...
    value2.setValue(Byte.valueOf((byte) 16));
    assertThat(expression2.getValue()).isEqualTo(ONE);
    value.setValue(Byte.valueOf((byte) 64));
