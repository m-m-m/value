...
public interface IntegerExpression extends ObservableIntegerValue, NumberExpression<Integer> {
  ...
  @Override
  default IntegerExpression expNegate() {
  ...
  @Override
  default IntegerExpression expAdd(ObservableShortValue other) {

    return IntegerBinding.add(this, other);
  }

  @Override
  default IntegerExpression expAdd(ObservableByteValue other) {
  ...
  @Override
  default IntegerExpression expAdd(short constant) {

    return IntegerBinding.add(this, constant);
  }

  @Override
  default IntegerExpression expAdd(byte constant) {
  ...
  @Override
  default IntegerExpression expSub(ObservableShortValue other) {

    return IntegerBinding.subtract(this, other);
  }

  @Override
  default IntegerExpression expSub(ObservableByteValue other) {
  ...
  @Override
  default IntegerExpression expSub(short constant) {

    return IntegerBinding.subtract(this, constant);
  }

  @Override
  default IntegerExpression expSub(byte constant) {
  ...
  @Override
  default IntegerExpression expMul(ObservableShortValue other) {

    return IntegerBinding.multiply(this, other);
  }

  @Override
  default IntegerExpression expMul(ObservableByteValue other) {
  ...
  @Override
  default IntegerExpression expMul(short constant) {

    return IntegerBinding.multiply(this, constant);
  }

  @Override
  default IntegerExpression expMul(byte constant) {
  ...
  @Override
  default IntegerExpression expDiv(ObservableShortValue other) {

    return IntegerBinding.divide(this, other);
  }

  @Override
  default IntegerExpression expDiv(ObservableByteValue other) {
  ...
  @Override
  default IntegerExpression expDiv(short constant) {

    return IntegerBinding.divide(this, constant);
  }

  @Override
  default IntegerExpression expDiv(byte constant) {
