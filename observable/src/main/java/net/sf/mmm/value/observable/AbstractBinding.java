...
/**
 * Abstract base implementation of {@link Binding}.
 *
 * @param <V> type of the observable {@link #getValue() value}.
 * @since 1.0.0
 */
public abstract class AbstractBinding<V> extends AbstractObservableValue<V> implements Binding<V> {
   ...
   */
  public AbstractBinding(Supplier<? extends V> expression, ObservableValue<?>... dependencies) {
