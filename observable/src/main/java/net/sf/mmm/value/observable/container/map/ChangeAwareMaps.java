...
import net.sf.mmm.value.observable.container.map.impl.ChangeAwareMapImpl;
import net.sf.mmm.value.observable.container.map.impl.EmptyChangeAwareMap;
import net.sf.mmm.value.observable.container.map.impl.ImmutableChangeAwareMap;
