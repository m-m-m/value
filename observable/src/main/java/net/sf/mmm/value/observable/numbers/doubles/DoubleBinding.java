...
/**
 * {@link net.sf.mmm.value.observable.Binding} for a {@link Double} {@link #getValue() value}.
 *
 * @since 1.0.0
 */
public class DoubleBinding extends NumberBinding<Double> implements DoubleExpression {
   ...
   */
  @SafeVarargs
  public static DoubleExpression sum(ObservableValue<? extends Number>... observables) {
