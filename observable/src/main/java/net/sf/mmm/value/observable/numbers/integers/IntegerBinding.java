...
/**
 * {@link net.sf.mmm.value.observable.Binding} for a {@link Integer} {@link #getValue() value}.
 *
 * @since 1.0.0
 */
public class IntegerBinding extends NumberBinding<Integer> implements IntegerExpression {
   ...
   */
  @SafeVarargs
  public static IntegerExpression sum(ObservableValue<? extends Number>... observables) {
