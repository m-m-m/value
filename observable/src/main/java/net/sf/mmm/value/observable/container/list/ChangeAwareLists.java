...
import net.sf.mmm.value.observable.container.list.impl.ChangeAwareListImpl;
import net.sf.mmm.value.observable.container.list.impl.EmptyChangeAwareList;
import net.sf.mmm.value.observable.container.list.impl.ImmutableChangeAwareList;
