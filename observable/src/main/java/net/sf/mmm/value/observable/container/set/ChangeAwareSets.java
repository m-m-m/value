...
import net.sf.mmm.value.observable.container.set.impl.ChangeAwareSetImpl;
import net.sf.mmm.value.observable.container.set.impl.EmptyChangeAwareSet;
import net.sf.mmm.value.observable.container.set.impl.ImmutableChangeAwareSet;
